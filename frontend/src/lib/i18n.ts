...
export const TRANSLATIONS = {
  ko: {
    ...
    notificationHistoryOpen: "알림 기록 보기",
  ...
  en: {
    ...
    serverConnectingShort: "CONNECTING TO SERVER",
    ...
    notificationHistoryOpen: "Open notification history",
